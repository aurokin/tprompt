...
// under a race.
func runInteractiveImport(deps Deps, picker importtui.Renderer, source promptsource.Source, collisionSources []promptsource.Source, records []ImportRecord, flags importFlags, ensureDest func() error) error {
...
// invoke it.
func importSnippets(deps Deps, source promptsource.Source, collisionSources []promptsource.Source, records []ImportRecord, flags importFlags, ensureDest func() error, sel *importSelection) (imported, skipped int, err error) {
