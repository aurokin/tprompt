...
plan/classification tests (`internal/app/import_plan_test.go`), the interactive
picker model (`internal/importtui`) and its app wiring with a recording/stub
renderer (`internal/app/import_interactive_test.go`), exit-code mapping
